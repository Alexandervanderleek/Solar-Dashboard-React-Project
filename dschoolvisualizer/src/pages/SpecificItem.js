                  ...
                  <div className='mt-12 border-4 border-gray-500 p-3 rounded-xl'>
                    <div className='flex flex-col m-3'>
                      ...
                      <input type="text" placeholder="Type here" value={item.title} onChange={(e)=>{
                        ...
                        setItem({...item})
                      }} className="input input-lg input-bordered input-accent w-96 text-xl" />
                    </div>
                    ...
                    <select onChange={(e)=>{
                      ...
                      setItem({...item})
                    }} value={item.interval} className="select select-lg select-success w-full max-w-xs">
                    ...
                    <div className='flex flex-col m-3'>
                      <div className='text-2xl font-bold'>
                          ...
                          <select onChange={(e)=>{
                            ...
                            setItem({...item})
                          }} value={item.graph} className="select select-lg select-success w-full max-w-xs">
                    ...
                    <div className='flex flex-col m-3'>
                      <div className='text-2xl font-bold'>
                          ...
                          <select onChange={(e)=>{
                            ...
                            setItem({...item})
                          }} value={item.adNotes} className="select select-lg select-success w-full max-w-xs">
